...
--
-- Host: localhost    Database: cad_prod
-- ------------------------------------------------------
...
CREATE TABLE `cadastro_produto` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_categorias_id` (`categoria`),
  CONSTRAINT `fk_categorias_id` FOREIGN KEY (`categoria`) REFERENCES `categorias` (`id`)
...
INSERT INTO `cadastro_produto` VALUES (1,'Carro','controle remoto','12.00',4);
...
-- Dump completed on 2020-10-29 12:58:47
